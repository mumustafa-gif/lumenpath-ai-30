...
export const FacultyAIAssistant = () => {
  ...
  const handleQuickAction = async (actionType: string) => {
    ...
    switch (actionType) {
      case "lesson":
        dummyResponse = `📚 **Lesson Plan Generated: Introduction to Machine Learning**

**Course:** AI Fundamentals | **Duration:** 90 minutes | **Level:** Beginner
...
*Generated by Academic Counselor - Review and customize as needed*`;
        break;

      case "assessment":
        dummyResponse = `📝 **Assessment Created: Python Programming Fundamentals**

**Assessment Type:** Mixed Format Quiz | **Duration:** 45 minutes | **Total Points:** 100
...
*Generated by Academic Counselor - Customize difficulty and topics as needed*`;
        break;
...
*AI-generated recommendations based on learning science research*`;
    ...
    // Trigger a simulated message in the chat interface
    // This would need to be properly integrated with ChatInterface component
    console.log("Generated content for", actionType, ":", dummyResponse);
    setActiveQuickAction(null);
    
    // You would want to add this to the chat messages here
    // For now, we'll just show it in an alert for demonstration
    alert(`${actionType.toUpperCase()} GENERATED!\n\nContent has been generated and would appear in the chat. Check console for full content.`);
  };
        ...
        <Card className="h-full bg-gradient-to-br from-slate-50/95 via-white/95 to-blue-50/95 dark:from-slate-900/95 dark:via-slate-800/95 dark:to-blue-900/95 backdrop-blur-xl border-0 shadow-2xl ring-1 ring-black/5 dark:ring-white/10 overflow-hidden">
          ...
          {!isMinimized && (
            <div className="flex flex-col h-[calc(680px-100px)] overflow-hidden">
                ...
                <div className="p-6 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-900/10 dark:to-indigo-900/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="w-6 h-6 p-0 text-gray-500 hover:text-gray-700 transition-colors"
                  ...
                  <div className="space-y-3">
                    <Button 
                      variant="outline" 
                      className={`w-full h-14 justify-start space-x-4 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 border-emerald-200/50 dark:border-emerald-800/50 hover:shadow-lg hover:border-emerald-300 transition-all duration-300 group ${
                        activeQuickAction === "lesson" ? "ring-2 ring-emerald-500 bg-emerald-100 dark:bg-emerald-900/50 shadow-lg" : ""
                      }`}
                    ...
                    >
                      <div className={`w-10 h-10 rounded-full bg-emerald-500/10 flex items-center justify-center group-hover:bg-emerald-500/20 transition-colors ${
                        activeQuickAction === "lesson" ? "animate-pulse" : ""
                      }`}>
                        <FileText className="w-5 h-5 text-emerald-600" />
                      </div>
                      <div className="flex-1 text-left">
                        <div className="font-medium text-sm text-gray-900 dark:text-gray-100">
                          {activeQuickAction === "lesson" ? "Generating Lesson Plan..." : "Create Lesson Plan"}
                        </div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">
                          Generate structured learning content with objectives
                        </div>
                      </div>
                      {activeQuickAction === "lesson" && (
                    ...
                    <Button 
                      variant="outline" 
                      className={`w-full h-14 justify-start space-x-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-blue-200/50 dark:border-blue-800/50 hover:shadow-lg hover:border-blue-300 transition-all duration-300 group ${
                        activeQuickAction === "assessment" ? "ring-2 ring-blue-500 bg-blue-100 dark:bg-blue-900/50 shadow-lg" : ""
                      }`}
                      onClick={() => handleQuickAction("assessment")}
                      disabled={activeQuickAction === "assessment"}
                    >
                      <div className={`w-10 h-10 rounded-full bg-blue-500/10 flex items-center justify-center group-hover:bg-blue-500/20 transition-colors ${
                        activeQuickAction === "assessment" ? "animate-pulse" : ""
                      }`}>
                        <Target className="w-5 h-5 text-blue-600" />
                      </div>
                      <div className="flex-1 text-left">
                        <div className="font-medium text-sm text-gray-900 dark:text-gray-100">
                          {activeQuickAction === "assessment" ? "Creating Assessment..." : "Design Assessment"}
                        </div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">
                          Build quizzes and tests with rubrics
                        </div>
                      </div>
                    ...
                    <Button 
                      variant="outline" 
                      className={`w-full h-14 justify-start space-x-4 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-amber-200/50 dark:border-amber-800/50 hover:shadow-lg hover:border-amber-300 transition-all duration-300 group ${
                        activeQuickAction === "engagement" ? "ring-2 ring-amber-500 bg-amber-100 dark:bg-amber-900/50 shadow-lg" : ""
                      }`}
                    ...
                    >
                      <div className={`w-10 h-10 rounded-full bg-amber-500/10 flex items-center justify-center group-hover:bg-amber-500/20 transition-colors ${
                        activeQuickAction === "engagement" ? "animate-pulse" : ""
                      }`}>
                        <Users className="w-5 h-5 text-amber-600" />
                      </div>
                      <div className="flex-1 text-left">
                        <div className="font-medium text-sm text-gray-900 dark:text-gray-100">
                          {activeQuickAction === "engagement" ? "Planning Engagement..." : "Boost Engagement"}
                        </div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">
                          Strategies to increase student participation
                        </div>
                      </div>
                      {activeQuickAction === "engagement" && (
                        <div className="flex space-x-1">
              ...
              {isQuickActionsMinimized && (
                <div className="px-6 py-3 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-blue-50/30 to-indigo-50/30 dark:from-blue-900/5 dark:to-indigo-900/5">
