...
import { Bell, Settings, User, LogOut, GraduationCap } from "lucide-react";
      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Button variant="outline" size="icon" className="relative">
            ...
            {notifications > 0 && (
              <Badge className="absolute -top-2 -right-2 h-5 w-5 flex items-center justify-center p-0 bg-ai-info">
                {notifications}
              </Badge>
            )}
          </Button>
